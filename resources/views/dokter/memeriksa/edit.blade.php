...
@section('content_header_title', 'Edit Periksa')
...
@section('content_body')
    <form action="{{ route('memeriksa.update', $periksa->id) }}" method="POST">
        ...
        <div class="card">
            <div class="card-header bg-primary text-white">Edit Periksa</div>
            <div class="card-body">
...
{{-- ✅ Tempatkan di luar section agar stack bisa dikenali --}}
@push('css')
    <link href="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/css/select2.min.css" rel="stylesheet" />
@endpush

@push('js')
    <script src="https://code.jquery.com/jquery-3.6.0.min.js"></script> {{-- jQuery duluan --}}
    <script src="https://cdn.jsdelivr.net/npm/select2@4.1.0-rc.0/dist/js/select2.min.js"></script>

    <script>
        $(function() {
            let selectObat = $('select[name="obat[]"]');
            let totalField = $('input[name="total"]');
            let obatData = @json($obats->keyBy('id'));
